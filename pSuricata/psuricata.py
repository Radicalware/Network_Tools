...
if len(sys.argv) > 1:
	...
	-u               = Searches for querys that have a url (HTTP traffic)
	...
	Note, search color highlighting is Case Sensitive.
...
class Setup(object):
	def __init__(self, arguments):
		...
		if bool(re.search('Suricata 3.2',tester)) == False:
			print("Suricata 3.2 was not found in your path\nsudo apt-get install suricata"); quit()
